...
export default class SaoPauloContent extends Component {
  render() {
    return (
      <div className="WrapperContent">
        ...
        <Row>
          <Col lg={24}>
            <h1 className="Title">Programa São Paulo</h1>
          </Col>
        </Row>
        <Row className="ContentSection">
          ...
          <Col lg={12}>
						<div className="ItemList">
							<h4>1º Módulo - Mai: 24, 25 e 26</h4>
							<h5>Pedro Franco</h5>
							<ul>
						...
						<div className="ItemList">
							<h4>2º Módulo - Jun: 28, 29 e 30</h4>
							<h5>Pedro Franco</h5>
							<ul>
								<li>Yoga Tântrico</li>
							</ul>            
						...
						<div className="ItemList">
							<h4>3º Módulo - Jul: 26, 27 e 28</h4>
						...
						<div className="ItemList">
							<h4>4º Módulo - Ago: 23, 24 e 25</h4>
							<h5>Lucas Ribeiro</h5>         
							<p>
          ...
          <Col lg={12}>
						<div className="ItemList">
							<h4>5º Módulo - Set: 20, 21 e 22 </h4>
					...
					<Col lg={12}>
						<div className="ItemList">
							<h4>7º Módulo - Nov: 22, 23 e 24</h4>
							<h5>Felipe Peres</h5>
							<p>
