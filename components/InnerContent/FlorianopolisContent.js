...
export default class FlorianopolisContent extends Component {
  render() {
    return (
      <div className="WrapperContent">
        ...
        <Row>
          <Col lg={24}>
            <h1 className="Title">Programa Florianópolis</h1>
          </Col>
        </Row>
        <Row className="ContentSection">
          ...
          <Col lg={12}>
						...
						<div className="ItemList">
							<h4>2º Módulo - Jun: 14, 15 e 16</h4>
							<h5>Pedro Franco</h5>
							<ul>
								<li>Yoga Tântrico</li>
							</ul>            
          ...
          <Col lg={12}>
						<div className="ItemList">
							<h4>5º Módulo - Set: 06, 07 e 08 </h4>
					...
					<Col lg={12}>
						<div className="ItemList">
							<h4>6º Módulo - Out: 11, 12 e 13</h4>
							<h5>Pedro Franco</h5>
							<p>
								Revisão de conteúdo
					...
					<Col lg={12}>
					<div className="ItemList">
						<h4>8º Módulo - RETIRO - Nov/Dez: 29 e 30/11 e 01/12</h4>
