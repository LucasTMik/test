...
export default class RiodeJaneiroContent extends Component {
  render() {
    return (
        ...
        <Row className="ContentSection">
          ...
          <Col lg={12}>
						<div className="ItemList">
							<h4>1º Módulo - Abr: 12, 13 e 14</h4>
							<h5>Pedro Franco</h5>
							<ul>
						...
						<div className="ItemList">
							<h4>2º Módulo - Mai/jun: 31/05, 01 e 02/06</h4>
							<h5>Pedro Franco</h5>
							<ul>
								<li>Yoga Tântrico</li>
							</ul>            
						...
						<div className="ItemList">
							<h4>3º Módulo - Jun: 05, 06 e 07/07</h4>
						...
						<div className="ItemList">
							<h4>4º Módulo - Ago: 02, 03 e 04/08</h4>
							<h5>Lucas Ribeiro</h5>         
							<p>
          ...
          <Col lg={12}>
						<div className="ItemList">
							<h4>5º Módulo - Ago/Set: 30, 31/08 e 01/09 </h4>
					...
					<Col lg={12}>
						<div className="ItemList">
							<h4>6º Módulo - Out: 04, 05 e 06/10</h4>
							<h5>Pedro Franco</h5>
							<p>
								Revisão de conteúdo
					...
					<Col lg={12}>
						<div className="ItemList">
							<h4>7º Módulo - Nov: 08, 09 e 10</h4>
							<h5>Felipe Peres</h5>
							<p>
					...
					<Col lg={12}>
					<div className="ItemList">
						<h4>8º Módulo - RETIRO - Dez: 06, 07 e 08/12</h4>
